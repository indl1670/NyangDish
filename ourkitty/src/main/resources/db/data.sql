...
VALUES (1, 'dish1', './default.png', 10.123, 20.321, 'address4', '0020002', 'serial-1234-0001', 33.33, 5, 3, false,
        now(),
        now()),
       (2, 'dish2', './default.png', 20.123, 21.321, 'address5', '0020002', 'serial-1234-0002', 22.22, 3, 1, false,
        now(),
        now()),
       (3, 'dish3', './default.png', 20.123, 22.321, 'address6', '0020002', 'serial-5678-0003', 11.11, 7, 2, false,
        now(),
        now());
...
VALUES (1, 1, 2, '고양이 커여웡', '0040001', '0020002', false, now(), now()),
       (2, 2, 1, '고양이 커여웡', '0040002', '0020002', false, now(), now()),
       (3, 3, 1, '고양이 커여웡', '0040001', '0020002', false, now(), now());
