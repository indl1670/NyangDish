...
VALUES (1, 'client', '$2a$10$kNnSCr0rS0SxvR7w09F2FetmPh6doUi7GyrZAXsQ3BOSFEbY5YLha', 'name1', '테스트유저', '', 'address1', '01000000001', '0010001', '0020001',
        now(),
        '0110001', false, '',
        now(), now()),
       (2, 'admin', '$2a$10$kNnSCr0rS0SxvR7w09F2FetmPh6doUi7GyrZAXsQ3BOSFEbY5YLha', 'name2', '테스트관리자', '', 'address2', '01000000002', '0010002', '0020001',
        now(),
        '0110001', false, '',
        now(), now()),
       (3, 'test3@ssafy.com', '$2a$10$kNnSCr0rS0SxvR7w09F2FetmPh6doUi7GyrZAXsQ3BOSFEbY5YLha', 'name3', 'nickname3', '', 'address3', '01000000003', '0010001', '0020001',
        now(),
        '0110001', false, '',
        now(), now()),
       (4, 'test4@ssafy.com', '$2a$10$kNnSCr0rS0SxvR7w09F2FetmPh6doUi7GyrZAXsQ3BOSFEbY5YLha', 'name4', 'nickname3', '', 'address3', '01000000004', '0010001', '0020001',
        now(),
        '0110003', false, '이사',
        now(), now());
