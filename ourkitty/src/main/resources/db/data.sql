...
VALUES (1, 1, '2023-05-02', 100, 70.0, 5, 3, false, now(), now()),
       (2, 2, '2023-05-02', 100, 70.0, 5, 3, false, now(), now()),
       (3, 3, '2023-05-02', 100, 70.0, 5, 3, false, now(), now()),
       (4, 1, '2023-05-03', 80, 40.0, 6, 3, false, now(), now()),
       (5, 2, '2023-05-03', 80, 40.0, 6, 3, false, now(), now()),
       (6, 3, '2023-05-03', 80, 40.0, 6, 3, false, now(), now()),
       (7, 1, '2023-05-04', 40, 90.0, 6, 3, false, now(), now()),
       (8, 2, '2023-05-04', 40, 90.0, 6, 3, false, now(), now()),
       (9, 3, '2023-05-04', 40, 90.0, 6, 3, false, now(), now()),
       (10, 1, '2023-05-05', 90, 60.0, 6, 4, false, now(), now()),
       (11, 2, '2023-05-05', 90, 60.0, 6, 4, false, now(), now()),
       (12, 3, '2023-05-05', 90, 60.0, 6, 4, false, now(), now()),
       (13, 1, '2023-05-06', 70, 35.0, 5, 4, false, now(), now()),
       (14, 2, '2023-05-06', 70, 35.0, 5, 4, false, now(), now()),
       (15, 3, '2023-05-06', 70, 35.0, 5, 4, false, now(), now()),
       (16, 1, '2023-05-07', 20, 100.0, 5, 3, false, now(), now()),
       (17, 2, '2023-05-07', 20, 100.0, 5, 3, false, now(), now()),
       (18, 3, '2023-05-07', 20, 100.0, 5, 3, false, now(), now()),
       (19, 1, '2023-05-08', 90, 85.0, 5, 4, false, now(), now()),
       (20, 2, '2023-05-08', 90, 85.0, 5, 4, false, now(), now()),
       (21, 3, '2023-05-08', 90, 85.0, 5, 4, false, now(), now());
